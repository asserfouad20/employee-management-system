    ...
    <div className="p-6 relative">
      ...
      <div className="mb-4">
        <input
          ...
          className="border border-gray-300 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 hover:border-gray-400 transition-all duration-300 ease-in-out w-96"
        />
      </div>
