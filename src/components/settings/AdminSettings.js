                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        className="mt-1 w-full border border-gray-300 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 hover:border-gray-400 transition-all duration-300 ease-in-out disabled:bg-gray-100 disabled:text-gray-500"
                      />
                    </div>
