        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div>
            ...
            <select
              ...
              className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all duration-300 ease-in-out hover:border-teal-400"
            >
